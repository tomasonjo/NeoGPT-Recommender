examples = """
# What honor has Sarah Primrose achieved?
MATCH (a:Applicant)
WHERE a.LastName = 'Primrose' AND a.FirstName = 'Sarah'
MATCH (a)-[:HAS]-(h:Honor)
RETURN h;
# What honor has Michael Sutton achieved?
MATCH (a:Applicant)
WHERE a.LastName = 'Sutton' AND a.FirstName = 'Michael'
MATCH (a)-[:HAS]-(h:Honor)
RETURN h;
# What honor has Sean Withall achieved?
MATCH (a:Applicant)
WHERE a.LastName = 'Withall' AND a.FirstName = 'Sean'
MATCH (a)-[:HAS]-(h:Honor)
RETURN h;
# What state bar has Michael Sutton been admitted?
MATCH (a:Applicant)
WHERE a.LastName = 'Sutton' AND a.FirstName = 'Michael'
MATCH (a)-[:ADMITTED_BY]-(bar:Admission)
RETURN bar.OriginalName;
# What state bar has Sarah Primrose been admitted?
MATCH (a:Applicant)
WHERE a.LastName = 'Primrose' AND a.FirstName = 'Sarah'
MATCH (a)-[:ADMITTED_BY]-(bar:Admission)
RETURN bar.OriginalName;
# What state bar has Philip Wong been admitted?
MATCH (a:Applicant)
WHERE a.LastName = 'Wong' AND a.FirstName = 'Philip'
MATCH (a)-[:ADMITTED_BY]-(bar:Admission)
RETURN bar.OriginalName;
# What state bar has Samuel Lipson been admitted?
MATCH (a:Applicant)
WHERE a.LastName = 'Lipson' AND a.FirstName = 'Samuel'
MATCH (a)-[:ADMITTED_BY]-(bar:Admission)
RETURN bar.OriginalName;
# What law school did Joshua Spielman attend?
...
Return s
LIMIT 1
# What law school did Matthew Wochok attend?
...
return a2
LIMIT 25
# What law firm does Matthew Wochok work?
MATCH(a2:Applicant) where a2.LastName ='Wochok' and a2.FirstName ='Matthew'
MATCH (a2)-[:WORKS_AT]-(lf:LawFirm)
Return lf
LIMIT 1
# Who works at Gibbons law firm?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Gibbons'
MATCH (a2)-[:IS]-(status:Status) where status.OriginalName IN ['Newly added to the database','Recently changed','Not Changed','Lateral move','Lateral Move*','Newly Hired Graduates','Moved due to merger' ,'SECONDMENT']
return a2
LIMIT 25
# Where did Matthew Wochok earn his undergraduate degree?
MATCH(a2:Applicant) where a2.LastName ='Wochok' and a2.FirstName ='Matthew'
Return a2.Undergrad
LIMIT 1
...
Return a2.JdYear
LIMIT 1
# What candidate graduated from Georgetown University in 2010?
...
LIMIT 25
# Who at Morris Manning & Martin LLP law firm studied at Harvard University?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Morris Manning & Martin LLP'
MATCH (a2)-[:IS]-(status:Status) where status.OriginalName IN ['Newly added to the database','Recently changed','Not Changed','Lateral move','Lateral Move*','Newly Hired Graduates','Moved due to merger' ,'SECONDMENT']
MATCH (s:School)-[:STUDIED_AT]-(a2:Applicant) WHERE s.OriginalName ='Harvard'
return a2
LIMIT 25
# Who at Gibbons law firm studied at Georgetown University?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Gibbons'
MATCH (a2)-[:IS]-(status:Status) where status.OriginalName IN ['Newly added to the database','Recently changed','Not Changed','Lateral move','Lateral Move*','Newly Hired Graduates','Moved due to merger' ,'SECONDMENT']
MATCH (s:School)-[:STUDIED_AT]-(a2:Applicant) WHERE s.OriginalName ='Georgetown University'
return a2
LIMIT 25
# What candidate earned their undergraduate degree from U OF VIRGINIA and graduated from Georgetown University in 2010?
MATCH (s:School)-[:STUDIED_AT]-(a2:Applicant) WHERE s.OriginalName ='Georgetown University'
MATCH (a2)-[:IS]-(status:Status) where status.OriginalName IN ['Newly added to the database','Recently changed','Not Changed','Lateral move','Lateral Move*','Newly Hired Graduates','Moved due to merger' ,'SECONDMENT']
MATCH (a2: Applicant) where a2.JdYear=2010
...
return a2, s
LIMIT 25
# What candidate earned their undergraduate degree from U OF GEORGIA and graduated from Duke in 2015?
...
return a2, s
LIMIT 25
# What candidate earned their undergraduate degree from U OF SOUTHERN CALIFORNIA and graduated from Duke in 2015?
MATCH (s:School)-[:STUDIED_AT]-(a2:Applicant) WHERE s.OriginalName ='Duke'
MATCH (a2)-[:IS]-(status:Status) where status.OriginalName IN ['Newly added to the database','Recently changed','Not Changed','Lateral move','Lateral Move*','Newly Hired Graduates','Moved due to merger' ,'SECONDMENT']
...
return a2, s
LIMIT 25
# What candidate earned their undergraduate degree from AUSTRALIA and graduated from Australian National University in 2019?
...
return a2, s
LIMIT 25
# What candidate earned their undergraduate degree from U OF DELAWARE at Gibbons law firm?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Gibbons'
MATCH (a2)-[:IS]-(status:Status) where status.OriginalName IN ['Newly added to the database','Recently changed','Not Changed','Lateral move','Lateral Move*','Newly Hired Graduates','Moved due to merger' ,'SECONDMENT']
MATCH (a2: Applicant) where a2.Undergrad='U OF DELAWARE'
Return a2
LIMIT 25
# What candidate earned their undergraduate degree from U OF GEORGIA at Morris Manning & Martin LLP law firm?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Morris Manning & Martin LLP'
MATCH (a2)-[:IS]-(status:Status) where status.OriginalName IN ['Newly added to the database','Recently changed','Not Changed','Lateral move','Lateral Move*','Newly Hired Graduates','Moved due to merger' ,'SECONDMENT']
MATCH (a2:Applicant) where a2.Undergrad='U OF GEORGIA'
Return a2
LIMIT 25
# Who at Morris Manning & Martin LLP law firm graduated law school at Emory in 1996?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Morris Manning & Martin LLP'
...
return a2, s
LIMIT 25
# Who at Gibbons law firm graduated law school at Seton Hall in 2012?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Gibbons'
...
return a2, s
LIMIT 25
# Who at Morris Manning & Martin LLP law firm attended AUBURN U for undergrad and law school at Cumberland?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Morris Manning & Martin LLP'
...
return a2, s
LIMIT 25
# Who at Gibbons law firm attended SETON HALL U for undergrad and law school at Rutgers?
MATCH (lf:LawFirm)-[:WORKS_AT]-(a2:Applicant) WHERE lf.Name ='Gibbons'
...
Return a.Email
LIMIT 1
# What is Samuel Lipson's personal email address?
MATCH(a:Applicant) where a.LastName ='Lipson' and a.FirstName ='Samuel'
MATCH (a)-[:IS]-(status:Status)
WHERE status.OriginalName IN ['Newly added to the database', 'Recently changed', 'Not Changed', 'Lateral move', 'Lateral Move*', 'Newly Hired Graduates', 'Moved due to merger', 'SECONDMENT']
Return a.Email
LIMIT 1
# What is Joshua Spielman's cell phone number?
MATCH(a:Applicant) where a.LastName ='Spielman' and a.FirstName ='Joshua'
MATCH (a)-[:IS]-(status:Status)
WHERE status.OriginalName IN ['Newly added to the database', 'Recently changed', 'Not Changed', 'Lateral move', 'Lateral Move*', 'Newly Hired Graduates', 'Moved due to merger', 'SECONDMENT']
Return a.Phone
LIMIT 1
# What is Samuel Lipson's cell phone number?
MATCH(a:Applicant) where a.LastName ='Lipson' and a.FirstName ='Samuel'
MATCH (a)-[:IS]-(status:Status)
WHERE status.OriginalName IN ['Newly added to the database', 'Recently changed', 'Not Changed', 'Lateral move', 'Lateral Move*', 'Newly Hired Graduates', 'Moved due to merger', 'SECONDMENT']
Return a.Phone
LIMIT 1
# What candidates working at Gibbons law firm speak 2 or more languages?
...
LIMIT 10;
# What candidates working at Morris Manning & Martin LLP law firm speak 2 or more languages?
